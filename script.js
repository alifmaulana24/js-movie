...
//     fetch('http://www.omdbapi.com/?apikey=53fc0cb7&s=' + inputKeyword.value)
...
//             fetch('http://www.omdbapi.com/?apikey=53fc0cb7&i=' + imdbid) 
//              .then(response => response.json())
//              .then(m =>  {
...
function getMovies(keyword) {
    return fetch('http://www.omdbapi.com/?apikey=53fc0cb7&s=' + keyword)
     .then(response => {
        if(!response.ok) {
...
function getMovieDetail(imdbid) {
     return fetch('http://www.omdbapi.com/?apikey=53fc0cb7&i=' + imdbid) 
    .then(response => response.json())
    .then(m => m) 
...
function showCards(m) {
   return `<div class="col-4 my-3 ">
                        ...
                        <div class="card-body">
                            ...
                            data-target="#movieDetailModal" data-imdbid = ${m.imdbID} >Show for details</a>
                        </div>
                        </div>
                    </div>`
}
